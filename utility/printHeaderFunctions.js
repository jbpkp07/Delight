...
function printHeader() {
    ...
    terminal("\n");
    terminal.brightBlue(" ┌─────────────────────────────────────────────────────────────────────────────┐\n");
    terminal.brightBlue(" │").brightCyan("                                   Delight                                   ").brightBlue("│\n");
    terminal.brightBlue(" │").brightCyan("                                    v1.0                                     ").brightBlue("│\n");
    terminal.brightBlue(" │").cyan("            Martell Harding, Jeremy Barnes, Griffin Sprague-Dixon").brightBlue("            │\n");
    terminal.brightBlue(" ├─────────────────────────────────────────────────────────────────────────────┤\n");
    ...
    terminal.brightBlue(" │                                                                             │\n");
    terminal.brightBlue(" │").brightCyan(" Description : ").gray("Welcome to Delight, a Node.js / Express.js webapp!").brightBlue("            │\n");
